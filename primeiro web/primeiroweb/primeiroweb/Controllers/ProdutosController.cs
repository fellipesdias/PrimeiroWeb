...
namespace primeiroweb.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        {
            ViewData["CategoriaId"] = new SelectList(_context.Categorias, "Id", dataTextField: "Descricao");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Quantidade,CategoriaId")] Produto produto)
        {
            ...
            ViewData["CategoriaId"] = new SelectList(_context.Categorias, "Id", dataTextField: "Descricao", produto.CategoriaId);
            return View(produto);
        }
